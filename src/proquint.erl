...
decode_byte($h)-> << 4:4/bits >>;
decode_byte($j)-> << 5:4/bits >>;
decode_byte($k)-> << 6:4/bits >>;
decode_byte($l)-> << 7:4/bits >>;
decode_byte($m)-> << 8:4/bits >>;
decode_byte($n)-> << 9:4/bits >>;
decode_byte($p)-> << 10:4/bits >>;
decode_byte($r)-> << 11:4/bits >>;
decode_byte($s)-> << 12:4/bits >>;
decode_byte($t)-> << 13:4/bits >>;
decode_byte($v)-> << 14:4/bits >>;
decode_byte($z)-> << 15:4/bits >>.
